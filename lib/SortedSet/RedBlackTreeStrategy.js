...
var _AbstractBinaryTreeStrategy = _interopRequireDefault(require("./AbstractBinaryTreeStrategy"));
...
class RedBlackTreeStrategy extends _AbstractBinaryTreeStrategy.default {
  constructor(options) {
    super();
...
;
var _default = RedBlackTreeStrategy;
